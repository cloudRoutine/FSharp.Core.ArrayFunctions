...
let website = "/FSharp.Core.ArrayFunctions"

let githubLink = "http://github.com/cloudroutine/FSharp.Core.ArrayFunctions"

// Specify more information about your project
let info =
  [ "project-name", "FSharp.Core.ArrayFunctions"
    "project-author", "Jared Hester"
    "project-summary", "Normalizes the collections API for multi-dimensional arrays"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/FSharp.Core.ArrayFunctions" ]
